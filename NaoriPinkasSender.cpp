...
void NaoriPinkasSender::initServerAndAccept(){
    ...
    std::cout << "Server socket accept" << std::endl;
...
void NaoriPinkasSender::initialize(){
    std::cout << "Sender read from file" << std::endl;
    NaoriPinkasSenderData::readInitDataFromFile(this -> path, this -> data);
    std::cout << "Start Socket Accepted" << std::endl;
    initServerAndAccept();
    ...
    std::cout << "NpReceiver Data " << std::endl << value;
